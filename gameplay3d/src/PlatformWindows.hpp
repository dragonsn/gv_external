...
bool createWindow(WindowCreationParams* params, HWND* hwnd, HDC* hdc)
{
    ...
    *hwnd = CreateWindowExA(styleEx, "gameplay", windowName.c_str(), style, 0, 0, rect.right - rect.left, rect.bottom - rect.top, NULL, NULL, __hinstance, NULL);
    if (*hwnd == NULL)
    {
...
Platform* Platform::create(Game* game, void* attachToWindow)
{
	...
	if (!FileSystem::getResourcePath()) FileSystem::setResourcePath("./");
    ...
    else
    {
        ...
        SetWindowLongPtr(__hwnd, GWLP_WNDPROC, (INT_PTR)(WNDPROC)__WndProc);
...
int Platform::startupMessagePump()
{
	GP_ASSERT(_game);
...
/**
* second step of enterMessagePump
*/
bool Platform::tickMessagePump()
{
	//GVM_DEBUG_OUT("XXX tickMessagePump");
	MSG msg;
	while (true)
	{
...
{
    if (!startupMessagePump() ) return 0;
	while(tickMessagePump()) {}
    return 0;
}
...
bool Platform::launchURL(const char* url)
{
	...
	gv_int_ptr r = (gv_int_ptr)ShellExecuteA(NULL, NULL, url, NULL, NULL, SW_SHOWNORMAL);
    return (r > 32);
}
