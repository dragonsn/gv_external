...
int althrd_create(althrd_t *thr, althrd_start_t func, void *arg)
{
	...
	cntr = (thread_cntr *)malloc(sizeof(*cntr));
...
int alcnd_init(alcnd_t *cond)
{
	_int_alcnd_t *icond = (_int_alcnd_t *)calloc(1, sizeof(*icond));
...
int alcnd_signal(alcnd_t *cond)
{
	_int_alcnd_t *icond = (_int_alcnd_t *)cond->Ptr;
