...
static inline void ApplyCoeffsStep_c(ALuint Offset, ALfloat (*restrict Values)[2],
                                   const ALuint IrSize,
...
static inline void ApplyCoeffs_c(ALuint Offset, ALfloat (*restrict Values)[2],
                               const ALuint IrSize,
                               ALfloat (*restrict Coeffs)[2],
                               ALfloat left, ALfloat right)
{
...
#define ApplyCoeffsStep ApplyCoeffsStep_c
#define ApplyCoeffs ApplyCoeffs_c

#define SUFFIX C
#include "mixer_inc.hpp"
#undef SUFFIX

#undef ApplyCoeffsStep
#undef ApplyCoeffs
