...
////////////////////////////////////////////////////////////////////////////////
uint32_t CxImage::GetTypeIdFromName(const char* ext)
{
#if CXIMAGE_SUPPORT_BMP
	if (_tcsnicmp(ext,("bmp"),3)==0 )		return CXIMAGE_FORMAT_BMP;
#endif
#if CXIMAGE_SUPPORT_JPG
	if (_tcsnicmp(ext,("jpg"),3)==0 ||
		_tcsnicmp(ext,("jpe"),3)==0 ||
		_tcsnicmp(ext,("jfi"),3)==0 )		return CXIMAGE_FORMAT_JPG;
#endif
#if CXIMAGE_SUPPORT_GIF
	if (_tcsnicmp(ext,("gif"),3)==0 )		return CXIMAGE_FORMAT_GIF;
#endif
#if CXIMAGE_SUPPORT_PNG
	if (_tcsnicmp(ext,("png"),3)==0 )		return CXIMAGE_FORMAT_PNG;
#endif
#if CXIMAGE_SUPPORT_ICO
	if (_tcsnicmp(ext,("ico"),3)==0 ||
		_tcsnicmp(ext,("cur"),3)==0 )		return CXIMAGE_FORMAT_ICO;
#endif
#if CXIMAGE_SUPPORT_TIF
	if (_tcsnicmp(ext,("tif"),3)==0 )		return CXIMAGE_FORMAT_TIF;
#endif
#if CXIMAGE_SUPPORT_TGA
	if (_tcsnicmp(ext,("tga"),3)==0 )		return CXIMAGE_FORMAT_TGA;
#endif
#if CXIMAGE_SUPPORT_PCX
	if (_tcsnicmp(ext,("pcx"),3)==0 )		return CXIMAGE_FORMAT_PCX;
#endif
#if CXIMAGE_SUPPORT_WBMP
	if (_tcsnicmp(ext,("wbm"),3)==0 )		return CXIMAGE_FORMAT_WBMP;
#endif
#if CXIMAGE_SUPPORT_WMF
	if (_tcsnicmp(ext,("wmf"),3)==0 ||
		_tcsnicmp(ext,("emf"),3)==0 )		return CXIMAGE_FORMAT_WMF;
#endif
#if CXIMAGE_SUPPORT_JP2
	if (_tcsnicmp(ext,("jp2"),3)==0 ||
		_tcsnicmp(ext,("j2k"),3)==0 )		return CXIMAGE_FORMAT_JP2;
#endif
#if CXIMAGE_SUPPORT_JPC
	if (_tcsnicmp(ext,("jpc"),3)==0 ||
		_tcsnicmp(ext,("j2c"),3)==0 )		return CXIMAGE_FORMAT_JPC;
#endif
#if CXIMAGE_SUPPORT_PGX
	if (_tcsnicmp(ext,("pgx"),3)==0 )		return CXIMAGE_FORMAT_PGX;
#endif
#if CXIMAGE_SUPPORT_RAS
	if (_tcsnicmp(ext,("ras"),3)==0 )		return CXIMAGE_FORMAT_RAS;
#endif
#if CXIMAGE_SUPPORT_PNM
	if (_tcsnicmp(ext,("pnm"),3)==0 ||
		_tcsnicmp(ext,("pgm"),3)==0 ||
		_tcsnicmp(ext,("ppm"),3)==0 )		return CXIMAGE_FORMAT_PNM;
#endif
#if CXIMAGE_SUPPORT_JBG
	if (_tcsnicmp(ext,("jbg"),3)==0 )		return CXIMAGE_FORMAT_JBG;
#endif
#if CXIMAGE_SUPPORT_MNG
	if (_tcsnicmp(ext,("mng"),3)==0 ||
		_tcsnicmp(ext,("jng"),3)==0 )		return CXIMAGE_FORMAT_MNG;
#endif
#if CXIMAGE_SUPPORT_SKA
	if (_tcsnicmp(ext,("ska"),3)==0 )		return CXIMAGE_FORMAT_SKA;
#endif
#if CXIMAGE_SUPPORT_PSD
	if (_tcsnicmp(ext,("psd"),3)==0 )		return CXIMAGE_FORMAT_PSD;
#endif
#if CXIMAGE_SUPPORT_RAW
	if (_tcsnicmp(ext,("nef"),3)==0 ||
		_tcsnicmp(ext,("crw"),3)==0 ||
		_tcsnicmp(ext,("cr2"),3)==0 ||
		_tcsnicmp(ext,("dng"),3)==0 ||
		_tcsnicmp(ext,("arw"),3)==0 ||
		_tcsnicmp(ext,("erf"),3)==0 ||
		_tcsnicmp(ext,("3fr"),3)==0 ||
		_tcsnicmp(ext,("dcr"),3)==0 ||
		_tcsnicmp(ext,("raw"),3)==0 ||
		_tcsnicmp(ext,("x3f"),3)==0 ||
		_tcsnicmp(ext,("mef"),3)==0 ||
		_tcsnicmp(ext,("raf"),3)==0 ||
		_tcsnicmp(ext,("mrw"),3)==0 ||
		_tcsnicmp(ext,("pef"),3)==0 ||
		_tcsnicmp(ext,("sr2"),3)==0 ||
		_tcsnicmp(ext,("orf"),3)==0 )		return CXIMAGE_FORMAT_RAW;
#endif
...
{
	static const char CxImageVersion[] = ("CxImage 7.0.2");
