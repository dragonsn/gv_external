...
namespace ELuna
{
	...
	template<> inline void push2lua(lua_State *L, float ret) { lua_pushnumber(L, (lua_Number)ret); };
	template<> inline void push2lua(lua_State *L, double ret) { lua_pushnumber(L, (lua_Number)ret); };
